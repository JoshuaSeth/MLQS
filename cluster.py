...
from distance_metrics import InstanceDistanceMetrics
import sklearn
import pandas as pd
import numpy as np
from sklearn.metrics import silhouette_samples, silhouette_score
from distance_metrics import PersonDistanceMetricsNoOrdering
from distance_metrics import PersonDistanceMetricsOrdering
import random
import scipy
...
class NonHierarchicalClustering:
    ...
    def k_means_over_instances(self, dataset, cols, k, distance_metric, max_iters, n_inits, idx, p=1 ):
        ...
        dataset['cluster_'+str(idx)] = kmeans.labels_
        print(dataset['cluster_'+str(idx)])
